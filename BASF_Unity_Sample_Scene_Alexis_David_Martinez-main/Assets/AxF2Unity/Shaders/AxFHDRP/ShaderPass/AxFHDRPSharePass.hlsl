...
// This first set of defines allows to say which attributes will be used by the mesh in the vertex and domain shader (for tesselation)
...
// #define ATTRIBUTES_NEED_COLOR // why?!
...
#endif
// #define VARYINGS_NEED_COLOR // why?!
